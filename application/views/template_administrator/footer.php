<footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            <a href="<?= $link_web ; ?>" target="_blank"><?=$creator ;  ?></a> for a better web.
          </div>
        </div>
      </footer>
    </div>
      ...
      <ul class="dropdown-menu">
        ...
        <li class="active">
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="<?= base_url('assets/') ; ?>assets/img/sidebar-1.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="<?= base_url('assets/') ; ?>assets/img/sidebar-2.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="<?= base_url('assets/') ; ?>assets/img/sidebar-3.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="<?= base_url('assets/') ; ?>assets/img/sidebar-4.jpg" alt="">
          </a>
        </li>
  ...
  <script>
    $('.form-check-input').on('click', function() {
      ...
      $.ajax({
        ...
        success: function() {
          document.location.href = "<?= base_url('Admin/lihat_role_access/');  ?>" + roleId;
        }
      });
    });
  </script> -->
